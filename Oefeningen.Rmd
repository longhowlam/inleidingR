...
F.  Create also a smoothe line per brand
G.	Create a facets by brand, each facet should have a histogram of the price 
H.	Create facets by brand and type, each facet should contain a scatter plot between price and KM stand
