...
B.	Remove outlying points and create plot again using alpha = 0.4
C.	Filter the set so that we only have the top eight brands (based on # observations)
D.	Create a new scatter plot, now the points should be colored  by brand, using the subset of the previous exercise 
E.	Create a facets by brand, each facet should have a histogram of the price 
F.	Create facets by brand and type, each facet should contain a scatter plot between price and KM stand
