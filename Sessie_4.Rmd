...
We beginnen met lineaire regressie. Modellen waar de Target variable continu (numeric) is. We nemen als voorbeeld de data in mtcars. waarin we horse power (hp) voorspellen op basis van een aantal input variabelen.
