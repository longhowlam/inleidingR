...
```{r}
sparse_matrix = sparse.model.matrix( Survived ~ Sex + Age +Pclass, data = TTrain)

xgboost.out = xgboost(sparse_matrix, label = TTrain$Survived, nrounds = 10)
...
xgboost.out = xgboost(params=param, sparse_matrix, label = TTrain$Survived, nrounds = 10)
```
