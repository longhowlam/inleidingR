...
Of als iemand een bepaalde reeks transacties heeft welke regel hoort daar bij en welk product kan je dan aanraden

```{r}
PersoonA = data.frame(
  id = rep(1,3),
  item = c("whole milk","butter","jam")
)
...
inspect(trxs_trans)
trxs_trans = Groceries[1]


rulesMatch <- is.subset(rules,trxs_trans)
