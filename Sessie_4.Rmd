...
Elk model heeft bepaalde parameters die je kan zetten, dit hoeft niet, dan worden defualt waarden gekozen.
...
```{r, eval = FALSE}
# classificatie voorbeeld, dan moet je factor target hebben en factor inputs (geen character)
...
plot(tmp, col = cars.cluster$cluster )
