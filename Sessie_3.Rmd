...
Met gganimate kan je animaties in je ggplot maken, het package kan nu alleen via github geinstalleerd worden.
...
Stel we animeren op gears we hebben drfie waarden van gears
