...
Er zijn veel mogelijkheden om data te plotten in R. In deze sessie zullen we een aantal type plots behandelen, de traditionele plots, ggplot2 en interactieve plots.
