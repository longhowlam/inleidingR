...
Je kan ook vormen/polygons op een leaflet kaart krijgen. Hieronder is een voorbeeld om op postcode 2 posities niveau een kaart te maken. We hebben eerst de data nodig die de contouren van een PC2 gebied definieert, en dan is er wat preparatie nodig om de data in polygoon objecten te krijgen.
...
Interactiven sunburst plots kan je ook mooi gebruiken voor hierarchische data.
