...
Je kan ook vormen/polygons op een leaflet kaart krijgen. Hieronder is een voorbeeld om op postcode 2 posities niveau een kaart te maken. We hebben eerst de data nodig die de contouren van een PC2 gebied definieert.

```{r, eval = FALSE}
# importeer data
pc2_kaart <- read_csv("data/pc2_kaart.csv")
PC2_data = dplyr::select(pc2_kaart, Longitude, Latitude, PC2CODE ) %>% as.data.frame()
