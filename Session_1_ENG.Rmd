---
title: 'Evening Session 01: Data types/structures'
subtitle: "Intro R"
author: "Longhow Lam"
output:
...
Be aware that in R a double can be equal to an integer. In other languages this can be different. 
...
# vertical pipe is testing on "this"" OR "that""
TRUE | FALSE    # OR
x < 7 | x > 8
```
