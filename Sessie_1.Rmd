...
Organiseer je R werk in projecten. Een project kan bestaan uit verschillende scripts, notebooks, data en output, deze wil je handig in 1 folder hebben. In RStudio kan je heel handig met verschillende R projecten werken. Via de GUI kun je nieuwe projecten aanmaken en beheren.  
...
Een R notebook kan je "knit" ('breien') tot een html/pdf/word document. De header van het markdown document vertelt hoe het een en ander gebreid moet worden. Zie bijvoorbeeld dit document. Als je op de 'Preview' knop drukt boven in het R notebook krijg je een apart window te zien met het resultaat van het R notebook. Er wordt dan ook een file.nb.html file door RStudio gemaakt, dit is een html file die je kan delen met anderen.
