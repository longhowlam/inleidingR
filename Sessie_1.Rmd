...
In R zijn `factors` bedoeld om categorische variabelen te representeren. Denk aan geslacht, of opleiding. Verwar een factor niet met character, je kan factor variabelen wel van character variabelen maken.
...
Je kan aan een lijst extra componenten toevoegen.
