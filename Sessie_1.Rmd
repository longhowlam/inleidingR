...
R heeft ook standaard functies voor het inzelzen van text files, maar ik gebruik vaak `readr`, voor grote files is het veel sneller. En je ziet dan ook een progress bar.
