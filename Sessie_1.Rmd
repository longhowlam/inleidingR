...
In R zijn lijsten de meest generieke data structuur, het kan beschouwd woorden als een verzanmeling van andere data structuren. Een lijst kan een lijst bevatten, en lijsten zijn soms het resultaat van een functie die allerlei dingen teruggeeft in een lijst.
